...
Source0  : https://files.pythonhosted.org/packages/33/b9/d0b39d8882206f0ccf9123fc182b51009f68b9a7757006066f08c9d6be36/rtslib-fb-2.1.72.tar.gz
...
%prep
%setup -q -n rtslib-fb-2.1.72
cd %{_builddir}/rtslib-fb-2.1.72
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1589310505
